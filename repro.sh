...
echo ========================================================================
echo
echo Ubuntu + AdoptOpenJDK, unset MALLOC_TRIM_THRESHOLD_ 
echo
...
echo ========================================================================
echo
echo Ubuntu + AdoptOpenJDK, MALLOC_TRIM_THRESHOLD_=200000000
echo
...
echo ========================================================================
echo
echo Ubuntu + Ubuntu OpenJDK, unset MALLOC_TRIM_THRESHOLD_
echo
